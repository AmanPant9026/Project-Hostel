...
const Navbar = () => {
  ...
  return (
    <NavbarWrapper>
      ...
      {isOpen && (
        <MobileMenu>
          <MobileNavItem to="/" onClick={() => setIsOpen(false)}>
            Home
          </MobileNavItem>
          <MobileNavItem to="/features" onClick={() => setIsOpen(false)}>
            Features
          </MobileNavItem>
          <MobileNavItem to="/services" onClick={() => setIsOpen(false)}>
            Services
          </MobileNavItem>
          <MobileNavItem to="/contact" onClick={() => setIsOpen(false)}>
            Contact
          </MobileNavItem>
          <SignInButtonMobile
            onClick={() => {
